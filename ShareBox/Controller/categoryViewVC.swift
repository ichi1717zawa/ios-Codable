...
class categoryViewVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    let imageData : [UIImage] = [ UIImage(named: "a4")!,UIImage(named: "a5")!,UIImage(named: "a6")!,UIImage(named: "a4")!,UIImage(named: "a5")!,UIImage(named: "a6")!,UIImage(named: "a4")!,UIImage(named: "a5")!,UIImage(named: "a6")!,UIImage(named: "a4")!,UIImage(named: "a5")!,UIImage(named: "a6")!]
